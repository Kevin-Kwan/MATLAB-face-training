...
imd = imageDatastore('../test/', 'IncludeSubfolders',true,...
    'LabelSource','FolderNames');
...
imd.ReadFcn = @readAndPreprocessImage;
...
[trainDS] = splitEachLabel(imds,0.99,'randomize',true);
[testDS] = readimage(imds,1);
test = imread('C:\Users\Administrator\Desktop\face training\test\obama.jpg');
...
im = readAndPreprocessImage('C:\Users\Administrator\Desktop\face training\test\obama.jpg') ;
